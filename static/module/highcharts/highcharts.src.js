...
// default adapters below.
    ...
    defaultOptions = {
        colors: ['#7ec35d', '#5aa3cd', '#739e9b', '#d5a242', '#cb8e8d', '#d5d5d5',
...
// general renderer
    ...
    Pointer.prototype = {
        ...
        onDocumentMouseMove: function (e) {
            ...
            if (chartPosition && hoverSeries && !this.inClass(e.target, 'highcharts-tracker') && !chart.isInsidePlot(e.pageX - chartPosition.left - chart.plotLeft,
