...
(function() {
    ...
    var _addEventHandler = function(element, method, func) {
        if (element.addEventListener) { //ie9+、chrome、firefox
            element.addEventListener(method, func, false);
        } else if (element.attachEvent) { //ie7、ie8
            if (method == 'mouseover')
                method = 'mouseenter';
    ...
    var _removeEventHandler = function(element, method, func) {
        if (element.removeEventListener) { //ie9+、chrome、firefox
            element.removeEventListener(method, func, false);
        } else if (element.detachEvent) { //ie7、ie8
            if (method == 'mouseover')
                method = 'mouseenter';
    ...
    if (typeof define === "function" && define.amd) {
        define('module/zeroclipboard/ZeroClipboard-modify', ["require", "exports", "module"], function(require, exports, module) {
